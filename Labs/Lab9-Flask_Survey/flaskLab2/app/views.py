...
def submitSurvey():
    ...
    if 'username' in session:
        ...
        surveyResponse = {}
        surveyResponse['favClass'] = request.form.get('favClass')
        surveyResponse['assignments'] = request.form.get('assignments')
        surveyResponse['professor'] = request.form.get('professor')
